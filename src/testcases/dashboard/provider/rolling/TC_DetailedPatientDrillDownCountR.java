...
public class TC_DetailedPatientDrillDownCountR extends Setup {
	...
	public void startTestCase(Hashtable<String, String> data) throws IOException, InvalidFormatException {
		...
		exe.testexecute(Filelocation, "TC_DetailedPatientDDCountR", data);
	...
	public Object[][] getDataForProviderPatientDrillDownCount() throws IOException, InvalidFormatException {
		Object[][] object = ex.getDataingrid(Filelocation, "TC_DetailedPatientDDCountR_Data");
		return object;
	}
}
