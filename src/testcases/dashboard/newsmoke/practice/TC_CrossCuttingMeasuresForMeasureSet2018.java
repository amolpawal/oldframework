...
public class TC_CrossCuttingMeasuresForMeasureSet2018 extends Setup{
	 ...
	 * To verify crosscutting measures count is correct for measures Displayed in measure set.
	...
	@Test(dataProvider="CrosscuttingMeasuresForMeasureSet2018")
	public void TC_AllMeasures(Hashtable <String,String> data) throws IOException, InvalidFormatException
	{
		...
		exe.testexecute(Filelocation,"TC_CrossCuttingForMeasureSet",data);
	...
	@DataProvider(name="CrosscuttingMeasuresForMeasureSet2018")
    public Object[][] getDataFromDataprovider12() throws IOException, InvalidFormatException
	{
        String Filelocation=System.getProperty("user.dir")+rd.read_Configfile("SmokePractice");
        Setup.log.info("\ntest case Outcome For MeasureSet 2018"+Filelocation);
        Object[][] object=ex.getDataingrid(Filelocation,"TC_CrossCuttiForMeasureSet_Data");
        return object;    
    }
