...
/**
 * This test case to check Add Contact button is present
 *  Data is provided through data sheet from excel
 * @author awadhesh sengar
 * Date 12-1-2018
 */
public class TC_VerifyAddContactButtonPresent extends Setup{
	...
	@Test(dataProvider="VerifyAddContactButtom")
	public void TC_AllMeasures(Hashtable <String,String> data) throws IOException, InvalidFormatException
	{
		...
		exe.testexecute(Filelocation,"TC_VContactButton",data);
	...
	@DataProvider(name="VerifyAddContactButtom")
    public Object[][] getDataFromDataprovider12() throws IOException, InvalidFormatException
	{
        String Filelocation=System.getProperty("user.dir")+rd.read_Configfile("PMS");
        Object[][] object=ex.getDataingrid(Filelocation,"TC_VContactButton_data");
