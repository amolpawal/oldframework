...
import buisness.core.dashboard.provider.nonrolling.verifyDetailedPatientDrillDownCountNR;
...
import buisness.core.dashboard.provider.rolling.verifyDetailedPatientDrillDownCountR;
...
public class Provider extends Common{
	...
	public String meth(String elementmethod,String action,String locator,String...data)
	{
		...
		else if(action.equalsIgnoreCase("verifyDetailedPatientDrillDownCountR"))
		{
			verifyDetailedPatientDrillDownCountR obj=  new verifyDetailedPatientDrillDownCountR();
			result=obj.verifyDetailedPatientDrillDownCountR(elementmethod,locator)?"Pass":"Fail";	
		}
		else if(action.equalsIgnoreCase("verifyDetailedPatientDrillDownCountNR"))
		{
			verifyDetailedPatientDrillDownCountNR obj=  new verifyDetailedPatientDrillDownCountNR();
			result=obj.verifyDetailedPatientDrillDownCountNR(elementmethod,locator)?"Pass":"Fail";	
		}
		
		else if(action.equalsIgnoreCase("SelectMeasureSet"))
		{
