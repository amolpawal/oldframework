...
public class Practice extends Common {
	...
	// Added class for custom keyword by Amol Bande
	buisness.core.dashboard.Practice.smokeAAO.PracticeSmokeAAO practiceSmokeAAO = new buisness.core.dashboard.Practice.smokeAAO.PracticeSmokeAAO();
	...
	public String meth(String elementmethod,String action,String locator,String...data)
	{
		...
		try{
			...
			{
				result=practiceProvidersPopUpCountNR.verify(elementmethod, locator, data[0], data[1])?"Pass":"Fail";
			}
			...
			{
				System.out.println("inside practice provider pop up countR");
				result= practiceProvidersPopUpCountR.verify(elementmethod,locator,data[0],data[1]) ? "Pass":"Fail";
			}
			...
			{
				result= practiceAllProvidersPatientDrillDownCountNR.verify(elementmethod, locator, data[0], data[1])?"Pass":"Fail";
			}
	...
	//---------------------------------------------------------------------------------
			// Added by Amol Bande 
			// Test case :33 "TC_CrossCuttingMeasuresForMeasureSet2018"
			else if(action.equalsIgnoreCase("getmeasureativelist"))
			{
				result= practiceSmokeAAO.activemeasureset2018(elementmethod,locator) ? "Pass":"Fail";
			}
			// Test case :34 "TC_CrossCuttingMeasuresForMeasureSet2018"
			else if(action.equalsIgnoreCase("CrossCuttingeMeasuresForMeasureSet2018"))
			{
				result= practiceSmokeAAO.CrossCuttingMeasuresForMeasureSet2018(elementmethod,locator) ? "Pass":"Fail";
			}
			// Test case :35 "TC_OutcomeMeasuresForMeasureSet2018"
			else if(action.equalsIgnoreCase("OutcomeMeasuresForMeasureSet2018"))
				{
					result= practiceSmokeAAO.OutcomeMeasuresForMeasureSet2018(elementmethod,locator) ? "Pass":"Fail";
				}
			
			// Test case :37 "VerifyHeaderDetailsforPatientDDWhenOpenedForMeasure"
			else if(action.equalsIgnoreCase("UIdrillDownHeaderMeasure"))
				{
					result= practiceSmokeAAO.VerifyHeaderDetailsforPatientDDWhenOpenedForMeasure() ? "Pass":"Fail";
			}
			
			// Test case :38 "TC_VerifyHeaderDetailsforPatientDDWhenOpenedForPractice"
			else if(action.equalsIgnoreCase("UIdrillDownHeadersPractice"))
				{
				result= practiceSmokeAAO.TC_VerifyRegistryAvgOnPerformanceTrendModalForPractice() ? "Pass":"Fail";
			}
			
			// Test case :39 "VerifyHeaderDetailsforPatientDDWhenOpenedForProvider"
			else if(action.equalsIgnoreCase("UIdrillDownHeaderProvider"))
				{
					result= practiceSmokeAAO.VerifyHeaderDetailsforPatientDDWhenOpenedForProvider() ? "Pass":"Fail";
			}
			
			// Test case :40 "TC_VerifyRegistryAvgOnPerformanceTrendModalForPractice"
			else if(action.equalsIgnoreCase("RegistryAvgOnPerformanceTrendModalForPractice"))
				{
					result= practiceSmokeAAO.TC_VerifyRegistryAvgOnPerformanceTrendModalForPractice() ? "Pass":"Fail";
			}
			
			// Test case :43 "TC_VerifyRegistryAvgOnPerformanceTrendModalForPractice"
			else if(action.equalsIgnoreCase("VerifytooltipAgainstMeasures"))
				{
				 result= practiceSmokeAAO.TC_VerifytooltipAgainstMeasures() ? "Pass":"Fail";
				}
