...
public class VefiryElixirID extends Pms {
...

{
	...
	String query = config.getQuery("VefiryElixirID");
	...
	Setup.log.info("  Practice Elixir id   from database: "+Databasecount);
	Setup.log.info("  Practice Elixir id    from Application Interface: "+Webcount);
