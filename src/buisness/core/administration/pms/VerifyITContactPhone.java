...
public class VerifyITContactPhone extends Pms {
...

{
	...
	String query = config.getQuery("VerifyITContactPhone");
	...
	Setup.log.info("  ITContactPhone from database: "+Databasecount);
	Setup.log.info("  ITContactPhone  from Application Interface: "+Webcount);
