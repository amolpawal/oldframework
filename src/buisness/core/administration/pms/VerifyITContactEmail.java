...
public class VerifyITContactEmail extends Pms {
...

{
	...
	String query = config.getQuery("VerifyITContactEmail");
	...
	Setup.log.info("  ITContactEmail from database: "+Databasecount);
	Setup.log.info("  ITContactEmail  from Application Interface: "+Webcount);
