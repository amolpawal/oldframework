...
public class VerifyPracticeCity extends Pms {
...

{
	...
	String query = config.getQuery("VerifyPracticeCity");
	...
	Setup.log.info("Practice City  from database: "+Databasecount);
	Setup.log.info(" Practice City  from Application Interface: "+Webcount);
