...
public class VerifyPracticeZip extends Pms {
...

{
	...
	String query = config.getQuery("VerifyPracticeZip");
	...
	Setup.log.info("  PracticeZip   from database: "+Databasecount);
	Setup.log.info("  VerifyPracticeZip  from Application Interface: "+Webcount);
