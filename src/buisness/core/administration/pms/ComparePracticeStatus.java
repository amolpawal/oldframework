...
public class ComparePracticeStatus extends Pms {
...

{
	...
	String query = config.getQuery("ComparePracticeStatus");
	...
	Setup.log.info("Practice Status  from database : "+Databasecount);
	Setup.log.info("Practice Status from Application Interface: "+Webcount);
