...
public class VerifyPMrcmPushFileType extends Pms {
...

{
	...
	String query = config.getQuery("VerifyPMrcmPushFileType");
	...
	Setup.log.info("  PM/rcm Push File Type   from database: "+Databasecount);
	Setup.log.info("  PM/rcm Push File Type      from Application Interface: "+Webcount);
