...
public class VerifyPace  extends Pms {
...

{
	...
	String query = config.getQuery("VerifyPace");
	...
	Setup.log.info(" Pace from database: "+Databasecount);
	Setup.log.info(" Pace   from Application Interface: "+Webcount);
