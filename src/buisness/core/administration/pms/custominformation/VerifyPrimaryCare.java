...
public class VerifyPrimaryCare  extends Pms {
...

{
	...
	String query = config.getQuery("VerifyPrimaryCare");
	...
	Setup.log.info(" Verify Primary Care   from database: "+Databasecount);
	Setup.log.info(" Verify Primary Care   from Application Interface: "+Webcount);
