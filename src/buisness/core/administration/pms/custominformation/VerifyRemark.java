...
public class VerifyRemark  extends Pms {
...

{
	...
	String query = config.getQuery("VerifyRemark");
	...
	Setup.log.info(" Remark  from database: "+Databasecount);
	Setup.log.info(" Remark  from Application Interface: "+Webcount);
