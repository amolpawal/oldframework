...
public class VerifyPEmrVersion  extends Pms {
...

{
	...
	String query = config.getQuery("VerifyPEmrVersion");
	...
	Setup.log.info("  Practice EMR version  fetched    from database: "+Databasecount);
	Setup.log.info("  Practice EMR version fetched   from Application Interface: "+Webcount);
