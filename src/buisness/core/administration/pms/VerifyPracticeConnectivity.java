...
public class VerifyPracticeConnectivity extends   Pms {
...

{
	...
	String query = config.getQuery("VerifyPracticeConnectivity");
	...
	Setup.log.info("  Practice EHR Push method   from database: "+Databasecount);
	Setup.log.info("  Practice EHR Push method   from Application Interface: "+Webcount);
