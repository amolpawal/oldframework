...
public class verifyDetailedPatientDrillDownCountNR extends ProviderPatientDrillDownCount {
	...
	public boolean verifyDetailedPatientDrillDownCountNR(String elementmethod, String locator) throws InterruptedException {

		System.out.println("*******************verifyDetailedPatientDrillDownCountNR********************************");
		 Setup st = new Setup();
		 Thread.sleep(5000);
		...
		System.out.println("Patient Drill Down Count UI :"+PatientDrillDownCountUI);
		try {
