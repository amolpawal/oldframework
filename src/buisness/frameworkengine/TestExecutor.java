	...
	public void testexecute(String filelocation, String scriptnm, Hashtable<String, String> Table)
		...
		try {
			...
			for (int i = 1; i < nosteps; i++) {
				...
				// Adding new smoke test cases
				 else if(filelocation.toLowerCase().contains("practice_01.xlsx")){
								c = new buisness.keywords.dashboard.Practice();
								result = c.meth(elementmethod, action, locatorValue, data, data1);
							}
				 else if(filelocation.contains("SmokeAAo.xlsx")){
						c = new buisness.keywords.dashboard.Practice();
						result = c.meth(elementmethod, action, locatorValue, data, data1);
					}
				 else if(filelocation.contains("Common.xlsx")){
						c = new buisness.keywords.dashboard.Measureset();
						result = c.meth(elementmethod, action, locatorValue, data, data1);
					}
				 else if(filelocation.contains("SmokePractice.xlsx")){
						c = new buisness.keywords.dashboard.Practice();
						result = c.meth(elementmethod, action, locatorValue, data, data1);
					}
				 else if(filelocation.contains("SmokeLocation.xlsx")){
						c = new buisness.keywords.dashboard.Location();
						result = c.meth(elementmethod, action, locatorValue, data, data1);
					}
				 else if(filelocation.contains("SmokeProvider.xlsx")){
						c = new buisness.keywords.dashboard.Provider();
						result = c.meth(elementmethod, action, locatorValue, data, data1);
					}
				...
				//---------------------------------------------------------------------------------------
					...
					if (filelocation.toLowerCase().contains("location")) {
						...
						c = new buisness.keywords.administration.Practice();
						result = c.meth(elementmethod, action, locatorValue, data, data1);
					} else if (filelocation.toLowerCase().contains("pms")){
						c = new buisness.keywords.administration.Pms();
						result = c.meth(elementmethod, action, locatorValue, data,data1);
				...
				else if ((filelocation.toLowerCase().contains("measureset"))) {
					if (filelocation.toLowerCase().contains("common")) {
						c = new buisness.keywords.dashboard.Measureset();
						result = c.meth(elementmethod, action, locatorValue, data, data1);
					}
				   } 
